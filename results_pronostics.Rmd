...
Lors de votre inscription, on vous a demandé l'équipe qui selon vous sera championne du monde. On vous dévoile les prémiers résultats de l'enquête.  

* Le camenbert répresente l'occurence des équipes candidates au titre de Championne du monde.  
* Le diagramme en barre représente selon les tournois précedents le classement des équipes pré-sélectionnées.  

<br>
La France a été citée 13 fois. Y-a-t-il du chauvinisme ?  
...
classement_fifa<-classement_fifa %>%  
  rename("2022"="X2022",
         ...
         "1978"="X1978")
classement_fifa$Equipe<-as.character(classement_fifa$Equipe)
...
table_participants %>%   
  ...
  e_pie(Nbr, rm.x = FALSE, rm.y = FALSE, center = c("85%", "50%"), radius = c(0, 40)) %>% 
  e_tooltip(trigger = "item") %>% 
  e_title("Rétrospective selon les Mondiaux","équipes sélectionnés par les pronostiqueurs\n et occurences",right="right") %>% 
  e_theme("infographic") %>% 
