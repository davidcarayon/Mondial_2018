...
########################################
dataword<-dataword %>%  left_join(table_buteurs %>% filter(CSC != TRUE) %>% select(n, nom_complet,id_pays),by=c("word"="nom_complet")) %>%
...
<!-- ```{r,graph repartition buts,echo=FALSE,warning=FALSE,message=FALSE,fig.align="center",fig.width=12,fig.height=8} -->
<!-- table_buteurs<-read.csv2("data/table_buteurs.csv") -->
...
<!-- d3tree2( p , rootname = "Goals repartition" ) -->
<!-- ``` -->
